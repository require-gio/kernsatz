#!/bin/bash
# GPU-accelerated development script for kernsatz
...
echo -e "${BLUE}🚀 kernsatz GPU-Accelerated Development Mode${NC}"
echo ""
...
echo ""
echo -e "${BLUE}📦 Starting kernsatz in development mode...${NC}"
echo ""
