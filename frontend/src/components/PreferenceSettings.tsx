...
export function PreferenceSettings() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">Benachrichtigungen zu Beginn und Ende eines Meetings aktivieren oder deaktivieren</p>
          </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Datenspeicherorte</h3>
        <p className="text-sm text-gray-600 mb-6">
          Anzeigen und zugreifen, wo kernsatz deine Daten speichert
        </p>
        ...
        <div className="space-y-4">
          ...
          {/* Recordings Location */}
          <div className="p-4 border rounded-lg bg-gray-50">
            <div className="font-medium mb-2">Meeting-Aufnahmen</div>
            <div className="text-sm text-gray-600 mb-3 break-all font-mono text-xs">
        ...
        <div className="mt-4 p-3 bg-blue-50 rounded-md">
          <p className="text-xs text-blue-800">
            <strong>Hinweis:</strong> Datenbank und Modelle werden gemeinsam in deinem Anwendungsdatenverzeichnis für eine einheitliche Verwaltung gespeichert.
          </p>
        </div>
      </div>
