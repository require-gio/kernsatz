...
const Sidebar: React.FC = () => {
  ...
  const handleDelete = async (itemId: string) => {
    ...
    try {
      ...
      toast.error("Meeting konnte nicht gelöscht werden", {
  ...
  const handleEditConfirm = async () => {
    ...
    if (!newTitle) {
      toast.error("Meeting-Titel darf nicht leer sein");
      return;
    }
    ...
    try {
      ...
      toast.success("Meeting-Titel erfolgreich aktualisiert");
      ...
      toast.error("Meeting-Titel konnte nicht aktualisiert werden", {
        description: error instanceof Error ? error.message : String(error)
      });
    }
  };
      ...
      <TooltipProvider>
        <div className="flex flex-col items-center space-y-4 mt-4">
          ...
          <Tooltip>
            ...
            <TooltipContent side="right">
              <p>{isRecording ? "Aufnahme läuft..." : "Aufnahme starten"}</p>
            </TooltipContent>
          </Tooltip>
          ...
          {item.type === 'folder' ? (
            <>
              ...
              {searchQuery && item.id === 'meetings' && isSearching && (
                <span className="ml-2 text-xs text-blue-500 animate-pulse">Suche läuft...</span>
              )}
            </>
          ) : (
            <div className="flex flex-col w-full">
              ...
              {hasTranscriptMatch && (
                <div className="mt-1 ml-8 text-xs text-gray-500 bg-yellow-50 p-1.5 rounded border border-yellow-100 line-clamp-2">
                  <span className="font-medium text-yellow-600">Treffer:</span> {matchingResult.matchContext}
                </div>
              )}
            </div>
          )}
  ...
  return (
    <div className="fixed top-0 left-0 h-screen z-40">
            ...
            {!isCollapsed && (
              <div className="p-3">
                ...
                <div className="relative mb-1">
                  <InputGroup >
                    <InputGroupInput placeholder='Meeting-Inhalte durchsuchen...' value={searchQuery}
      ...
      <ConfirmationModal
        ...
        text="Bist du sicher, dass du dieses Meeting löschen möchtest? Diese Aktion kann nicht rückgängig gemacht werden."
      ...
      <Dialog open={editModalState.isOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="sm:max-w-[425px]">
          <VisuallyHidden>
            <DialogTitle>Meeting-Titel bearbeiten</DialogTitle>
          </VisuallyHidden>
          <div className="py-4">
            <h3 className="text-lg font-semibold mb-4">Meeting-Titel bearbeiten</h3>
