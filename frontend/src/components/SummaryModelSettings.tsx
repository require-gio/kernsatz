...
export function SummaryModelSettings({ refetchTrigger }: SummaryModelSettingsProps) {
  ...
  const handleSaveModelConfig = async (config: ModelConfig) => {
    try {
      ...
      toast.success('Modelleinstellungen erfolgreich gespeichert');
    } catch (error) {
    ...
    <div className='flex flex-col gap-4'>
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Automatische Zusammenfassung</h3>
            <p className="text-sm text-gray-600">Zusammenfassung nach Meeting-Ende (Stoppen) automatisch erstellen</p>
          </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <h3 className="text-lg font-semibold mb-4">Zusammenfassungs-Modell Konfiguration</h3>
        <p className="text-sm text-gray-600 mb-6">
          Konfigurieren Sie das KI-Modell für die Erstellung von Meeting-Zusammenfassungen.
        </p>
