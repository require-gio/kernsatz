...
export function PermissionsStep() {
    ...
    if (permissions.microphone === 'denied') {
      ...
      try {
        await invoke('open_system_settings');
          ...
          alert('Bitte aktiviere den Mikrofonzugriff unter Systemeinstellungen > Datenschutz & Sicherheit > Mikrofon');
      }
      return;
    }
    ...
    if (permissions.systemAudio === 'denied') {
      ...
      try {
        await invoke('open_system_settings');
          ...
          alert('Bitte aktiviere die Audioaufnahme unter Systemeinstellungen → Datenschutz & Sicherheit → Audioaufnahme');
      }
      return;
    }
  ...
  return (
    <OnboardingContainer
        ...
        description="kernsatz benötigt Zugriff auf dein Mikrofon und System-Audio, um Meetings aufzunehmen"
      step={4}
      hideProgress={true}
        ...
        <div className="space-y-4">
          ...
          <PermissionRow
            icon={<Mic className="w-5 h-5" />}
              title="Mikrofon"
              description="Erforderlich, um deine Stimme während Meetings aufzunehmen"
          ...
          <PermissionRow
            icon={<Volume2 className="w-5 h-5" />}
              title="System-Audio"
              description="Klicke auf Aktivieren, um die Audioaufnahme-Berechtigung zu erteilen"
        ...
        <div className="flex flex-col gap-3 pt-4">
          ...
          {!allPermissionsGranted && (
            <p className="text-xs text-center text-muted-foreground">
                Ohne Berechtigungen funktioniert die Aufnahme nicht. Du kannst sie später in den Einstellungen erteilen.
            </p>
          )}
        </div>
      </div>
