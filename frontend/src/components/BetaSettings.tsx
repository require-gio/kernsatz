    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
        ...
        <div className="text-sm text-yellow-800">
          <p className="font-medium">Beta-Funktionen</p>
          <p className="mt-1">
            Diese Funktionen werden noch getestet. Es können Probleme auftreten, und wir freuen uns über dein Feedback.
          </p>
        </div>
      </div>
      ...
      <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-sm text-blue-800">
          <strong>Hinweis:</strong> Wenn deaktiviert, werden Beta-Funktionen ausgeblendet. Deine bestehenden Meetings bleiben unberührt.
        </p>
      </div>
    </div>
  );
