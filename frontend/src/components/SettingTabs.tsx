...
export function SettingTabs({ 
  ...
  <TabsList>
    <TabsTrigger value="transcriptSettings">Transkript</TabsTrigger>
    <TabsTrigger value="modelSettings">KI-Zusammenfassung</TabsTrigger>
    <TabsTrigger value="recordingSettings">Einstellungen</TabsTrigger>
