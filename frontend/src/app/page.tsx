...
export default function Home() {
  ...
  const handleRecovery = async (meetingId: string) => {
    try {
      ...
      if (result.success) {
        toast.success('Meeting erfolgreich wiederhergestellt!', {
          description: result.audioRecoveryStatus?.status === 'success'
            ? 'Transkripte und Audio wiederhergestellt'
            : 'Transkripte wiederhergestellt (kein Audio verfügbar)',
      ...
      toast.error('Meeting-Wiederherstellung fehlgeschlagen', {
