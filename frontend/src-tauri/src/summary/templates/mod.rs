...
//! - macOS: `~/Library/Application Support/kernsatz/templates/`
//! - Windows: `%APPDATA%\kernsatz\templates\`
//! - Linux: `~/.config/kernsatz/templates/`
//!
...
pub use loader::{
    delete_custom_template, get_template, get_template_json, is_builtin_template,
