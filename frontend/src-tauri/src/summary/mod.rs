...
pub use template_commands::{
    __cmd__api_delete_template, __cmd__api_get_template_details, __cmd__api_get_template_json,
    __cmd__api_list_templates, __cmd__api_save_template, __cmd__api_validate_template,
    api_delete_template, api_get_template_details, api_get_template_json, api_list_templates,
