@echo off
REM kernsatz Build Script for Windows
...
echo 🚀 Building kernsatz application...
...
echo.
echo ========================================
echo    kernsatz Build Script - Help
echo ========================================
echo.
echo USAGE:
...
echo.
echo DESCRIPTION:
echo   This script builds the kernsatz Tauri application for Windows.
