...
- Artifacts prefixed with `kernsatz-test-`
...
```
kernsatz-{workflow}-{platform}-{target}-{version}
```

**Examples:**
- `kernsatz-devtest-macOS-aarch64-apple-darwin-0.1.3`
- `kernsatz-test-windows-x86_64-pc-windows-msvc-0.1.3`
- `kernsatz-macos-aarch64-release-0.1.3`
...
- `KERNSATZ_RSA_PUBLIC_KEY` - License validation public key
