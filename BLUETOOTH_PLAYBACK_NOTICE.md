...
When **reviewing recordings** in kernsatz, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **kernsatz records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing kernsatz recordings** - Use wired/speakers instead
...
### This is Not a kernsatz Bug

The issue is in **macOS's Bluetooth audio stack**, not in kernsatz's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a kernsatz bug. We've correctly recorded at 48kHz.
...
**A**: Yes! kernsatz now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: kernsatz v0.0.5+ on macOS
